...
Usa este repositoriode la organización GoIT como plantilla para crear el repositorio de tu proyecto. 
...
![Creatig repo from a template step 1](./assets/template-step-1.png)
